...
class Serveur extends Thread{
    ...
    public synchronized void removeClient(ConnexionClient client) {
        ...
        System.out.println(client.getPseudo()+"("+client.getClienSocket().getInetAddress().getHostAddress()+") vient de se deconnecter");
    }
